			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbar">
					<ul class="nav navbar-nav">
						<li><a href="" title="Agregar Playlist"><span class="glyphicon glyphicon-plus"></span></a></li>
						<li><a href="" title="Mis Playlist"><span class="glyphicon glyphicon-list"></span></a></li>
					</ul>

					<form action="" class="navbar-form navbar-left" role="search">
						<div class="form-group">
							<input type="text" class=" buscador form-control " placeholder="Buscar" title="Buscá Playlist y Usuarios">
						</div>
					</form>
