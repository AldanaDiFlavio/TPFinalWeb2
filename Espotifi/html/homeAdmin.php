...
<body  onload="imageRandom()">
	...
	<div id="principal" class="admin container">
		...
		<form action="graficos/graficosJP.php">
		  <b>Selecciona un periodo:</b>
			desde <input type="date" name="desde" step="1" min="2013-01-01" max="<?php echo date("Y-m-d");?>" value="2016-09-01">
			hasta <input type="date" name="hasta" step="2" min="2013-01-01" max="<?php echo date("Y-m-d");?>" value="<?php echo date("Y-m-d");?>">

		  <input class="boton btn btn-success" type="submit" value="Generar graficos">
		</form>
